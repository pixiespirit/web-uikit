...
const DivPx = ({ size }) => (jsx("span", { className: s$i.px, style: { width: size, height: size } }, void 0));
const DivGrow = () => jsx("span", { className: s$i.grow }, void 0);
...
const Label1 = (_a) => {
    ...
    return (jsx(Text, Object.assign({ as: as || 'p', className: [s$g.label1, className].join(' ') }, props, { children: props.children }), void 0));
};
const Label2 = (_a) => {
    var { className, as } = _a, props = __rest(_a, ["className", "as"]);
    return (jsx(Text, Object.assign({ as: as || 'p', className: [s$g.label2, className].join(' ') }, props, { children: props.children }), void 0));
};
const Label3 = (_a) => {
    var { className, as } = _a, props = __rest(_a, ["className", "as"]);
    return (jsx(Text, Object.assign({ as: as || 'p', className: [s$g.label3, className].join(' ') }, props, { children: props.children }), void 0));
};
const Label4 = (_a) => {
    var { className, as } = _a, props = __rest(_a, ["className", "as"]);
    return (jsx(Text, Object.assign({ as: as || 'p', className: [s$g.label4, className].join(' ') }, props, { children: props.children }), void 0));
};
/**
 *
...
const Label5 = (_a) => {
    var { className, as } = _a, props = __rest(_a, ["className", "as"]);
    return (jsx(Text, Object.assign({ as: as || 'p', className: [s$g.label5, className].join(' ') }, props, { children: props.children }), void 0));
};
/**
 *
 * @deprecated Since version 0.0.12 and will be deleted in version 0.1.0
...
const Label6 = (_a) => {
    var { className, as } = _a, props = __rest(_a, ["className", "as"]);
    return (jsx(Text, Object.assign({ as: as || 'p', className: [s$g.label6, className].join(' ') }, props, { children: props.children }), void 0));
};
...
const Calendar = (props) => {
    ...
    return (jsxs("div", Object.assign({ className: getClass$3(props) }, { children: [jsxs("div", Object.assign({ className: s$h.dateSelector }, { children: [!collapse && (jsx("div", Object.assign({ className: "cursor-pointer", onClick: onGoToPreviousMonth }, { children: jsx(ArrowLeftOutline, {}, void 0) }), void 0)), jsx("div", Object.assign({ className: "w-2/3 text-center" }, { children: jsxs(Label1, Object.assign({ semiBold: true }, { children: [toMonthString(timeController.getMonth()), " ", timeController.getFullYear()] }), void 0) }), void 0), !collapse && (jsx("div", Object.assign({ className: "cursor-pointer", onClick: onGoToNextMonth }, { children: jsx(ArrowRightOutline, {}, void 0) }), void 0))] }), void 0), jsxs("div", Object.assign({ className: s$h.header }, { children: [jsx("div", Object.assign({ className: s$h.cell }, { children: "CN" }), void 0), jsx("div", Object.assign({ className: s$h.cell }, { children: "T2" }), void 0), jsx("div", Object.assign({ className: s$h.cell }, { children: "T3" }), void 0), jsx("div", Object.assign({ className: s$h.cell }, { children: "T4" }), void 0), jsx("div", Object.assign({ className: s$h.cell }, { children: "T5" }), void 0), jsx("div", Object.assign({ className: s$h.cell }, { children: "T6" }), void 0), jsx("div", Object.assign({ className: s$h.cell }, { children: "T7" }), void 0)] }), void 0), jsx("div", Object.assign({ className: s$h.body }, { children: calendar.map((row, rowIdx) => {
                    return (jsxs(React.Fragment, { children: [row.map((cell, cellIdx) => {
                                return (jsxs("div", Object.assign({ className: getCellClass(props, selectedDate, cell), onClick: () => onCellClick(cell) }, { children: [cell && cell.getDate(), cell && includesDate(props.highlightDates, cell) && (jsx("span", { className: s$h.badge }, void 0))] }), rowIdx * 10 + cellIdx));
                            }), jsx("div", { className: s$h.break }, void 0)] }, rowIdx));
                }) }), void 0), props.showCollapseButton && (jsx("div", Object.assign({ className: s$h.collapseContainer }, { children: jsxs("div", Object.assign({ className: s$h.collapseButton, onClick: () => setCollapse(!collapse) }, { children: [collapse && jsx(ArrowDownOutline, {}, void 0), !collapse && jsx(ArrowUpOutline, {}, void 0)] }), void 0) }), void 0))] }), void 0));
};
...
const Card = (props) => {
    return (jsxs("div", Object.assign({ style: props.style, className: getClass$2(props) }, { children: [(jsx("div", Object.assign({ className: s$e.title }, { children: jsx(Label1, Object.assign({ semiBold: true }, { children: props.title }), void 0) }), void 0)), jsx("div", Object.assign({ className: s$e.body }, { children: props.children }), void 0)] }), void 0));
};
...
const CardThumbnail = (props) => {
    ...
    return (jsxs("div", Object.assign({ className: containerClasses.join(' ') }, { children: [jsx("div", Object.assign({ className: s$d.thumbnailWrapper, style: { height: props.thumbnailHeight } }, { children: jsx("img", { className: s$d.thumbnail, src: props.thumbnail, alt: props.thumbnailAlt }, void 0) }), void 0), jsx("div", Object.assign({ className: s$d.body }, { children: props.children }), void 0)] }), void 0));
};
...
const InternalCheckbox = (props, ref) => {
    ...
    return (jsxs("label", Object.assign({ className: classNames(styles$2.checkbox, {
            [styles$2.disabled]: props.disabled,
            [styles$2.checked]: props.checked
        }) }, { children: [jsx("span", Object.assign({ tabIndex: props.tabIndex, className: classNames(props.className, styles$2.wrapper), style: Object.assign(Object.assign({}, props.style), { 
                    //   @ts-ignore
                    '--checkbox-size': `${_size}px` }) }, { children: jsx("span", Object.assign({ className: styles$2.iconWrapper }, { children: jsx(CheckIcon, {}, void 0) }), void 0) }), void 0), jsx("span", Object.assign({ className: styles$2.label }, { children: props.children }), void 0), jsx("input", { ref: ref, id: props.id, name: props.name, type: "checkbox", disabled: props.disabled, checked: props.checked, onChange: (e) => {
                    var _a, _b;
...
const CheckIcon = () => {
    return (jsx("svg", Object.assign({ className: styles$2.checkIcon, width: "12", height: "10", viewBox: "0 0 12 10", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, { children: jsx("path", { d: "M8.9375 1.375L3.6875 6.625L1.0625 4", stroke: "currentColor", strokeWidth: "1.3", strokeLinecap: "round", strokeLinejoin: "round" }, void 0) }), void 0));
};
...
const PinCode = (props) => {
    ...
    return (jsx("div", Object.assign({ className: s$7.pinCodeContainer }, { children: jsxs("div", { children: [jsx("div", Object.assign({ className: s$7.pinCodeWrapper }, { children: values.map((value, i) => {
                    ...
                    }) }), void 0), jsx("p", Object.assign({ className: classNames(s$7.errorMessage, !error && s$7.errorHidden) }, { children: errorMessage }), void 0)] }, void 0) }), void 0));
};
...
const Radio = (props) => {
    return (jsxs("label", Object.assign({ className: s$6.container }, { children: [jsx("input", { type: "radio", className: s$6.input, name: props.name, value: props.value, 
                ...
                // Uncontrolled
                defaultChecked: props.defaultChecked, ref: props.forwardedRef }, void 0), jsx("span", Object.assign({ className: s$6.checkboxDot }, { children: jsx(DotIcon, {}, void 0) }), void 0), jsx(Label3, Object.assign({ medium: true, className: s$6.label }, { children: props.children }), void 0)] }), void 0));
};
...
const Textarea = forwardRef((props, ref) => {
    return (jsxs("div", Object.assign({ ref: ref, style: props.style, className: classNames(s$3.textareaWrapper, props.disabled && s$3.disabled, props.readonly && s$3.readonly, props.invalid && s$3.invalid) }, { children: [jsxs("div", Object.assign({ style: { display: 'flex' } }, { children: [jsx("div", Object.assign({ className: s$3.label }, { children: props.label }), void 0), props.required && props.label && jsx("div", Object.assign({ className: s$3.requiredLabel }, { children: "*" }), void 0)] }), void 0), jsx("textarea", { 
                // Value
...
const InternalToggle = (props, ref) => {
    ...
    return (jsxs("label", Object.assign({ className: classNames(styles$1.toggle, {
            ...
            [styles$1.disabled]: props.disabled
                    ...
                    // @ts-ignore
                    '--toggle-height': `${_height}px`, '--toggle-width': `${_width}px`, '--toggle-size': `${_side}px` }), className: classNames(styles$1.wrapper, props.className) }, void 0), jsx("span", Object.assign({ className: styles$1.label }, { children: props.children }), void 0), jsx("input", { ref: ref, id: props.id, disabled: props.disabled, name: props.name, type: "checkbox", checked: props.checked, onChange: (e) => {
                    var _a, _b;
