...
const DivPx = ({ size }) => (jsxRuntime.jsx("span", { className: s$h.px, style: { width: size, height: size } }, void 0));
const DivGrow = () => jsxRuntime.jsx("span", { className: s$h.grow }, void 0);
...
const Label1 = (_a) => {
    ...
    return (jsxRuntime.jsx(Text, Object.assign({ as: as || 'p', className: [s$f.label1, className].join(' ') }, props, { children: props.children }), void 0));
};
const Label2 = (_a) => {
    var { className, as } = _a, props = __rest(_a, ["className", "as"]);
    return (jsxRuntime.jsx(Text, Object.assign({ as: as || 'p', className: [s$f.label2, className].join(' ') }, props, { children: props.children }), void 0));
};
const Label3 = (_a) => {
    var { className, as } = _a, props = __rest(_a, ["className", "as"]);
    return (jsxRuntime.jsx(Text, Object.assign({ as: as || 'p', className: [s$f.label3, className].join(' ') }, props, { children: props.children }), void 0));
};
const Label4 = (_a) => {
    var { className, as } = _a, props = __rest(_a, ["className", "as"]);
    return (jsxRuntime.jsx(Text, Object.assign({ as: as || 'p', className: [s$f.label4, className].join(' ') }, props, { children: props.children }), void 0));
};
/**
 *
...
const Label5 = (_a) => {
    var { className, as } = _a, props = __rest(_a, ["className", "as"]);
    return (jsxRuntime.jsx(Text, Object.assign({ as: as || 'p', className: [s$f.label5, className].join(' ') }, props, { children: props.children }), void 0));
};
/**
 *
 * @deprecated Since version 0.0.12 and will be deleted in version 0.1.0
...
const Label6 = (_a) => {
    var { className, as } = _a, props = __rest(_a, ["className", "as"]);
    return (jsxRuntime.jsx(Text, Object.assign({ as: as || 'p', className: [s$f.label6, className].join(' ') }, props, { children: props.children }), void 0));
};
...
const Calendar = (props) => {
    ...
    return (jsxRuntime.jsxs("div", Object.assign({ className: getClass$3(props) }, { children: [jsxRuntime.jsxs("div", Object.assign({ className: s$g.dateSelector }, { children: [!collapse && (jsxRuntime.jsx("div", Object.assign({ className: "cursor-pointer", onClick: onGoToPreviousMonth }, { children: jsxRuntime.jsx(icon.ArrowLeftOutline, {}, void 0) }), void 0)),
            ...
            jsxRuntime.jsxs("div", Object.assign({ className: s$g.header }, { children: [jsxRuntime.jsx("div", Object.assign({ className: s$g.cell }, { children: "CN" }), void 0),
                    ...
                    jsxRuntime.jsx("div", Object.assign({ className: s$g.cell }, { children: "T3" }), void 0),
                    jsxRuntime.jsx("div", Object.assign({ className: s$g.cell }, { children: "T4" }), void 0),
                    jsxRuntime.jsx("div", Object.assign({ className: s$g.cell }, { children: "T5" }), void 0),
                    jsxRuntime.jsx("div", Object.assign({ className: s$g.cell }, { children: "T6" }), void 0),
                    jsxRuntime.jsx("div", Object.assign({ className: s$g.cell }, { children: "T7" }), void 0)] }), void 0),
            jsxRuntime.jsx("div", Object.assign({ className: s$g.body }, { children: calendar.map((row, rowIdx) => {
                    return (jsxRuntime.jsxs(React__default['default'].Fragment, { children: [row.map((cell, cellIdx) => {
                                return (jsxRuntime.jsxs("div", Object.assign({ className: getCellClass(props, selectedDate, cell), onClick: () => onCellClick(cell) }, { children: [cell && cell.getDate(),
                                        cell && includesDate(props.highlightDates, cell) && (jsxRuntime.jsx("span", { className: s$g.badge }, void 0))] }), rowIdx * 10 + cellIdx));
                            }),
                            jsxRuntime.jsx("div", { className: s$g.break }, void 0)] }, rowIdx));
                }) }), void 0),
            props.showCollapseButton && (jsxRuntime.jsx("div", Object.assign({ className: s$g.collapseContainer }, { children: jsxRuntime.jsxs("div", Object.assign({ className: s$g.collapseButton, onClick: () => setCollapse(!collapse) }, { children: [collapse && jsxRuntime.jsx(icon.ArrowDownOutline, {}, void 0),
...
const Card = (props) => {
    return (jsxRuntime.jsxs("div", Object.assign({ style: props.style, className: getClass$2(props) }, { children: [(jsxRuntime.jsx("div", Object.assign({ className: s$d.title }, { children: jsxRuntime.jsx(Label1, Object.assign({ semiBold: true }, { children: props.title }), void 0) }), void 0)),
...
const CardThumbnail = (props) => {
    ...
    return (jsxRuntime.jsxs("div", Object.assign({ className: containerClasses.join(' ') }, { children: [jsxRuntime.jsx("div", Object.assign({ className: s$c.thumbnailWrapper, style: { height: props.thumbnailHeight } }, { children: jsxRuntime.jsx("img", { className: s$c.thumbnail, src: props.thumbnail, alt: props.thumbnailAlt }, void 0) }), void 0),
