...
const ButtonChildren = (props) => {
    var _a;
    const btnSize = (_a = props.size) !== null && _a !== void 0 ? _a : SizeButton.MEDIUM;
    return (jsxs(React.Fragment, { children: [props.icon && jsx("span", Object.assign({ className: s$k.icon }, { children: props.icon }), void 0),
            props.icon && !props.stickIconAtPrefix && props.children && (jsx(DivPx, { size: btnSize.iconMargin }, void 0)),
            props.children && (jsx("span", Object.assign({ className: classnames(s$k.text, props.stickIconAtPrefix && s$k.textGrow) }, { children: props.children }), void 0))] }, void 0));
};
const Button = (props) => {
    var _a;
    const common = {
...
const Modal = (props) => {
    ...
    return (jsx(React.Fragment, { children: props.show && (jsx("div", Object.assign({ ref: modalRef, className: s$a.modal, onClick: (event) => {
                var _a;
                if (event.target === modalRef.current) {
                    (_a = props.setShow) === null || _a === void 0 ? void 0 : _a.call(props, !props.show);
                }
            } }, { children: jsx("div", Object.assign({ className: s$a.body }, { children: props.children }), void 0) }), void 0)) }, void 0));
};
...
const PinCode = (props) => {
    ...
    return (jsx("div", Object.assign({ className: s$8.pinCodeContainer }, { children: jsxs("div", { children: [jsx("div", Object.assign({ className: s$8.pinCodeWrapper }, { children: values.map((value, i) => {
                        return (jsx("input", { value: value, onChange: (e) => handleOnChange(e.currentTarget.value, i), className: classnames(s$8.input, error && s$8.inputError, s$8[size || SizePinCode.DEFAULT]), type: "text", ref: _inputRefs.ref(i), onKeyDown: (e) => handleKeyDown(e, i), inputMode: "numeric", autoComplete: "one-time-code", onPaste: () => handlePaste(i), required: true }, `pin-code-${i}`));
                    }) }), void 0),
                jsx("p", Object.assign({ className: classnames(s$8.errorMessage, !error && s$8.errorHidden) }, { children: errorMessage }), void 0)] }, void 0) }), void 0));
};
...
const DotIcon = () => {
    return (jsx("svg", Object.assign({ stroke: "currentColor", fill: "currentColor", strokeWidth: "0", viewBox: "0 0 8 16", className: s$7.dotIcon, height: "1em", width: "1em", xmlns: "http://www.w3.org/2000/svg" }, { children: jsx("path", { fillRule: "evenodd", d: "M0 8c0-2.2 1.8-4 4-4s4 1.8 4 4-1.8 4-4 4-4-1.8-4-4z" }, void 0) }), void 0));
};
const Radio = (props) => {
    return (jsxs("label", Object.assign({ className: s$7.container }, { children: [jsx("input", { type: "radio", className: s$7.input, name: props.name, value: props.value, 
                // Controlled
            ...
            jsx("span", Object.assign({ className: s$7.checkboxDot }, { children: jsx(DotIcon, {}, void 0) }), void 0),
            jsx(Label3, Object.assign({ medium: true, className: s$7.label }, { children: props.children }), void 0)] }), void 0));
};
...
const Toggle = (props) => {
    return (jsxs("label", Object.assign({ className: classnames(s$3.switch, getColorClass(props)) }, { children: [jsx("input", { type: "checkbox", className: s$3.input, name: props.name, checked: props.checked, onChange: (e) => props.setChecked(e.target.checked), defaultChecked: props.defaultChecked, disabled: props.disabled }, void 0),
            jsx("div", { className: s$3.circle }, void 0)] }), void 0));
};
