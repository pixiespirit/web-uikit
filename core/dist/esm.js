...
const ButtonChildren = (props) => {
    var _a;
    const btnSize = (_a = props.size) !== null && _a !== void 0 ? _a : SizeButton.MEDIUM;
    return (jsxs(React.Fragment, { children: [props.leftIcon && jsx("span", Object.assign({ className: s$j.icon }, { children: props.leftIcon }), void 0),
            props.leftIcon && !props.stickIconAtPrefix && props.children && jsx(DivPx, { size: btnSize.iconMargin }, void 0),
            props.children && (jsx("span", Object.assign({ className: classNames(s$j.text, props.stickIconAtPrefix && s$j.textGrow) }, { children: props.children }), void 0)),
            props.rightIcon && !props.stickIconAtPrefix && props.children && jsx(DivPx, { size: btnSize.iconMargin }, void 0),
            props.rightIcon && jsx("span", Object.assign({ className: s$j.icon }, { children: props.rightIcon }), void 0)] }, void 0));
};
const Button = (props) => {
    var _a;
    const common = {
...
const Calendar = (props) => {
    ...
    return (jsxs("div", Object.assign({ className: getClass$3(props) }, { children: [jsxs("div", Object.assign({ className: s$h.dateSelector }, { children: [!collapse && (jsx("div", Object.assign({ className: "cursor-pointer", onClick: onGoToPreviousMonth }, { children: jsx(ArrowLeftOutline, {}, void 0) }), void 0)),
                    jsx("div", Object.assign({ className: "w-2/3 text-center" }, { children: jsxs(Label1, Object.assign({ semiBold: true }, { children: [toMonthString(timeController.getMonth()), " ", timeController.getFullYear()] }), void 0) }), void 0),
            ...
            jsxs("div", Object.assign({ className: s$h.header }, { children: [jsx("div", Object.assign({ className: s$h.cell }, { children: "CN" }), void 0),
                    jsx("div", Object.assign({ className: s$h.cell }, { children: "T2" }), void 0),
                    jsx("div", Object.assign({ className: s$h.cell }, { children: "T3" }), void 0),
                    jsx("div", Object.assign({ className: s$h.cell }, { children: "T4" }), void 0),
                    jsx("div", Object.assign({ className: s$h.cell }, { children: "T5" }), void 0),
                    jsx("div", Object.assign({ className: s$h.cell }, { children: "T6" }), void 0),
                    jsx("div", Object.assign({ className: s$h.cell }, { children: "T7" }), void 0)] }), void 0),
            jsx("div", Object.assign({ className: s$h.body }, { children: calendar.map((row, rowIdx) => {
                    return (jsxs(React.Fragment, { children: [row.map((cell, cellIdx) => {
                                return (jsxs("div", Object.assign({ className: getCellClass(props, selectedDate, cell), onClick: () => onCellClick(cell) }, { children: [cell && cell.getDate(),
                                        cell && includesDate(props.highlightDates, cell) && (jsx("span", { className: s$h.badge }, void 0))] }), rowIdx * 10 + cellIdx));
                            }),
                            jsx("div", { className: s$h.break }, void 0)] }, rowIdx));
                }) }), void 0),
            props.showCollapseButton && (jsx("div", Object.assign({ className: s$h.collapseContainer }, { children: jsxs("div", Object.assign({ className: s$h.collapseButton, onClick: () => setCollapse(!collapse) }, { children: [collapse && jsx(ArrowDownOutline, {}, void 0),
...
const Card = (props) => {
    return (jsxs("div", Object.assign({ style: props.style, className: getClass$2(props) }, { children: [(jsx("div", Object.assign({ className: s$e.title }, { children: jsx(Label1, Object.assign({ semiBold: true }, { children: props.title }), void 0) }), void 0)),
...
const CardThumbnail = (props) => {
    ...
    return (jsxs("div", Object.assign({ className: containerClasses.join(' ') }, { children: [jsx("div", Object.assign({ className: s$d.thumbnailWrapper, style: { height: props.thumbnailHeight } }, { children: jsx("img", { className: s$d.thumbnail, src: props.thumbnail, alt: props.thumbnailAlt }, void 0) }), void 0),
...
var s$3 = {"textareaWrapper":"index-module_textareaWrapper__3yuIs","textarea":"index-module_textarea__3h7dd","invalid":"index-module_invalid__3p6SY","caption":"index-module_caption__3kQIR","readonly":"index-module_readonly__RWnwC","disabled":"index-module_disabled__SX75T","label":"index-module_label__IAsOX","requiredLabel":"index-module_requiredLabel__elj1e"};

const Textarea = forwardRef((props, ref) => {
    return (jsxs("div", Object.assign({ ref: ref, style: props.style, className: classNames(s$3.textareaWrapper, props.disabled && s$3.disabled, props.readonly && s$3.readonly, props.invalid && s$3.invalid) }, { children: [jsxs("div", Object.assign({ style: { display: 'flex' } }, { children: [jsx("div", Object.assign({ className: s$3.label }, { children: props.label }), void 0),
                    props.required && jsx("div", Object.assign({ className: s$3.requiredLabel }, { children: "*" }), void 0)] }), void 0),
            jsx("textarea", { 
                // Value
            ...
            jsx("div", Object.assign({ className: s$3.caption }, { children: props.caption }), void 0)] }), void 0));
});
