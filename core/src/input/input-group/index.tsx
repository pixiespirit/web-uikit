...
export const InputGroup: SFC<InputGroupProps> = forwardRef((props, ref: ForwardedRef<HTMLDivElement>) => {
    ...
    validChildren.forEach((child: any) => {
        if (child.type.id === 'InputLeftIcon') {
            const imageSize = child?.props?.children?.props?.size ?? child?.props?.children?.props?.width ?? 16;
            groupStyles.style = {
