...
import { getAllDateOfMonth, includesDate, toCalendarMatrix } from '@/calendar/utils';
...
const getCellClass = (props: CalendarProps, selectedDate: Date, calendarDate: Date | undefined): string => {
...
export const Calendar: React.FC<CalendarProps> = (props) => {
    ...
    const [timeController, setTimeController] = useState<Date>(new Date(selectedDate));
        ...
        <div className={getClass(props)}>
            <div className={s.dateSelector}>
                ...
                <div className="w-2/3 text-center">
                    <Label1 semiBold>
                        {toMonthString(timeController.getMonth())} {timeController.getFullYear()}
                    </Label1>
                </div>
                {!collapse && (
            ...
            {props.showCollapseButton && (
                <div className={s.collapseContainer}>
                    <div className={s.collapseButton} onClick={() => setCollapse(!collapse)}>
