...
const SvgFacebookSolid = (props: IconProps) => (
  <Icon
    title={'SvgFacebookSolid'}
    {...props}
    children={
      <svg
        width="1em"
      ...
      >
        ...
        />
        <path
          d="M15.893 14.89l.443-2.89h-2.773v-1.875c0-.791.386-1.563 1.628-1.563h1.262v-2.46s-1.144-.196-2.238-.196c-2.285 0-3.777 1.385-3.777 3.89V12h-2.54v2.89h2.54v6.989a10.056 10.056 0 003.124 0V14.89h2.33z"
          fill="#fff"
        />
      </svg>
    }
